...
<html amp>
	<meta charset="utf-8">
	<title><?php echo strip_tags($contentDetails['title']); ?> | Kannadaprabha</title>
	...
	<meta name="twitter:creator" content="@Kannadaprabha.com" />
	...
	<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Hind&amp;display=swap" media="all">
	...
	<?php if($contentDetails['section_id']==161):	?>
	...
	<script type="application/ld+json">
			{
				...
				"headline": "<?php echo str_replace(["\'" ] , ["'"] , strip_tags($contentDetails['title'])); ?>",
				...
				"publisher": {
					...
					"logo": {
						"@type": "ImageObject",
						"url": "<?php echo image_url; ?>images/FrontEnd/images/kp-mob-logo.png",
						"width": "450",
						"height": "130"
					}
				},
				"inLanguage": "kn",
				"keywords": "<?php echo str_replace(["\'" ] , ["'"] , strip_tags($contentDetails['tags'])); ?>",
				"author": {
					"@type": "Person",
	...
	<style amp-custom>
		...
		header .menu-bar{font-size: 25px;color: #910000;float: left;margin-left: 2%;}
		header .logo_img{float: left;margin-left: 20%;margin-top:-8px;}
		nav{float:left;width:96%;overflow-x:scroll;padding: 2%;display:flex;flex:1;display:flex;background: #910000; }
		...
		.section-name{float: left;margin: 6px 0 8px;background:#000;color: #fff;padding: 3px 7px 4px;font-size: 14px;    border-radius: 8px;font-weight: 700;}
		...
		.article-content{width: 100%;float: left;font-family: 'Hind',serif;line-height: 1.7;font-size: 16px;text-align: justify;}
		.tags{float:left;width:100%;margin-bottom: 10px;}
		.tags span{float:left;margin-right: 10px;}
		.tags a{margin: 0px 6px 6px;text-decoration: none;background: #910000;color: #fff;padding: 1px 5px 2px;border-radius: 5px;float:left;}
		...
		.more-stories{float: left;width: 100%;flex: 1;display: flex;overflow-x: scroll;padding: 15px 0 15px;border-top: 2px solid #910000;border-bottom: 2px solid #910000;}
	...
	<body>
		...
		<div style="max-width: 600px; margin: 0 auto;">
			<header>
				...
				<a href="<?php echo BASEURL; ?>" class="logo_img"><amp-img src="<?php echo image_url.'images/FrontEnd/images/kp-mob-logo.png'; ?>" alt="" height="38" width="124"></amp-img></a>
				<div class="social-icons-n">
					<a target="_blank" href="https://www.facebook.com/kannadaPrabhaOnline"><amp-img src="<?php echo image_url.'images/amp-icons/facebook-is1.png'; ?>" alt="" height="24" width="24"></amp-img></a>
					<a target="_blank" href="https://twitter.com/KannadaPrabha"><amp-img src="<?php echo image_url.'images/amp-icons/twitter-is.png'; ?>" alt="" height="24" width="24"></amp-img></a>
					<a target="_blank" href="https://instagram.com/kannadaprabha/"><amp-img src="<?php echo image_url.'images/amp-icons/instagram-is.png'; ?>" alt="" height="24" width="24"></amp-img></a>
				</div>
			</header>
			<nav>
				<?php
			...
			<section>
				...
				if($contentDetails['article_page_image_path']!='' && $contentType==2){
					...
					if (getimagesize(image_url_no . imagelibrary_image_path . $image)){
						...
						echo '<amp-img src="'.image_url . imagelibrary_image_path.$image.'" alt="'.htmlentities(strip_tags($contentDetails['article_page_image_alt'])).'" height="'.$imageheight.'" width="'.$imagewidth.'" layout="responsive"></amp-img>';
						echo '</div>';
					}
				}
				?>
				...
				<div class="article-content">
					<?php
						...
						echo $finalcontent;
						if($contentType==2){
							if($contentDetails['section_id']==161){
								...
								$path='/var/www/html/kp_app/application/views/LIVENOW/';
				...
				<amp-sticky-ad layout="nodisplay">
					<amp-ad width="320" height="50" type="doubleclick" data-slot="/3167926/KNP_AMP_Sticky_320x50" rtc-config='{"vendors": { "aps": {"PUB_ID": "600", "PUB_UUID": "c3703fef-358e-4353-a111-eb049ab39167", "PARAMS":{"amp":"1"}} }}'></amp-ad> 
				</amp-sticky-ad>

				<amp-ad width=1 height=1    type="doubleclick"  data-slot="/3167926/KNP_AMP_Interstitial_1x1"> </amp-ad>

			</section>
			<footer>
				<p>Copyright - kannadaprabha.com<?php echo ' '.date('Y') ?> </p>
